...
Skills are automatically invoked when you ask your coding agent to:
...
| `skills/ralph/` | Skill for converting PRDs to JSON (works with Codex, Amp, and Claude Code) |
